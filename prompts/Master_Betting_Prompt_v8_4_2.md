...
☐ Tier limits respected?     [T1: X/8, T1B: X/8, T2: X/4, T3: X/2]
...
|------|-------|----------|-----------|
| T1 | AST, SOG, REC | 1% | 8 bets |
| T1B | REB Unders ONLY | 1% | 8 bets |
| T2 | PTS, REB Overs, Yards, Totals, Spreads, Team Totals, ML Fav | 2% | 4 bets |
...
|------------|----|----|----|----|
| Variance | 1.00 | 1.00 | 0.85 | 0.65 |
| Tier | 1.00 | 1.00 | 0.90 | 0.60 |
...
- T1 stats (AST, SOG, REC) + T1B (REB Unders) = lowest variance
...
10. **Daily tier limits** — T1 ≤8, T1B ≤8, T2 ≤4, T3 ≤2
...
│ DAILY LIMITS                                                    │
├─────────────────────────────────────────────────────────────────┤
│ T1 (AST/SOG/REC):     8 bets max, 1%+ edge                     │
│ T1B (REB Unders):     8 bets max, 1%+ edge                     │
│ T2 (PTS/REB Over/Lines): 4 bets max, 2%+ edge                  │
...
**v8.4.2 (February 11, 2026) - REB Fix Only:**
- REB sigma widened: 0.40 → 0.55 (fix overconfident REB Over probabilities; REB Overs were 8-16, -11.09u)
- G6 gate added: REB Overs require ≥6% edge to pass (block marginal REB overs)
- T1B tier added: REB Unders keep T1 treatment (76.9% WR, +8.23u); REB Overs moved to T2
- NO other sigma/formula/gate changes from v8.2
