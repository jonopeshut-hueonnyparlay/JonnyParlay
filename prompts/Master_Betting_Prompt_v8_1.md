# MASTER BETTING PROMPT v8.1

## STATUS
```
PP Status:    FUNDED (Passed Phase 2)
PP Cushion:   $100.00
PP Mode:      AGGRESSIVE
...
═══════════════════════════════════════════════════════════════════
SECTION 7: PLAYERPROFIT PICKS (if applicable)
═══════════════════════════════════════════════════════════════════
[T1 picks meeting PP gates]

═══════════════════════════════════════════════════════════════════
SECTION 8: DISCORD CARD (copy/paste ready)
═══════════════════════════════════════════════════════════════════
[Formatted picks]

═══════════════════════════════════════════════════════════════════
SECTION 9: TOP 5 SAFEST PICKS
═══════════════════════════════════════════════════════════════════
...
ALLOCATION:
☐ Props ~60% of action?      [X.Xu of Y.Yu total]
☐ Game lines ~25%?           [X.Xu of Y.Yu total]
☐ SGP ≤15%?                  [X.Xu of Y.Yu total]
...
│ 27. Prepare CLV tracking fields                                 │
│ 28. COMPLETE OUTPUT VERIFICATION CHECKLIST                      │
└─────────────────────────────────────────────────────────────────┘
```
...
11. **Allocation check** — ~60% props, ~25% game lines, ~15% SGP
...
12. **Track CLV on every bet**
13. **Line shop every bet across 4 books**
14. **Respect daily tier limits**
15. **Complete OUTPUT VERIFICATION CHECKLIST before finalizing**
