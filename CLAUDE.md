...
- `GAME_SIGMA["WNBA"]` (run_picks.py): `total`=17.459, `team`=11.271 (spread/ml unchanged at 10.0 — no active WNBA spread/ML picks). Calibrated 2026-06-05 from 837 games. Prior values total=10.0/team=7.5 were placeholders.
...
- **WNBA go-live gate**: need 100 graded picks (pick_score>0) post-dampener (Jun 3+) — **98/100** as of 2026-06-09 (prior gate_check.py over-reported as 101 — was including P/VOID results; fixed commit b84a208). Log: pick_log_wnba.csv. **At go-live also recalibrate the early-season sigma-inflation factors (0.80/0.90 carried over from the old edge-mult — DATA_GATED, Plan 6 §14).**
