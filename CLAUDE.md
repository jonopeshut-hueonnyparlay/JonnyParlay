...
- **K NB r=5.0 PROVISIONAL**: no MLB pitcher game logs in projections.db. Cannot calibrate. Defer until MLB data infrastructure built (statsapi game log fetcher + nb_calibrate.py MLB extension). Limited impact: K unders banned, K overs require line ≥6.0.
