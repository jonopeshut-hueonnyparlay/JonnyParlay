...
- `_REB_RATE_PRIOR` (PO): PG=0.135, SG=0.139, SF=0.140, PF=0.175, C=0.246. RS: PG=0.128, SG=0.132, SF=0.168, PF=0.210, C=0.305. Corrected per-36 ratios from StatMuse (was ~2× deflated). **RESOLVED (EdgeModel 3836cb2, 2026-06-07)**
