...
**Test progression:** 903 → 919 (post first batch, +16) → 941 (post H1, +22) → 941 (post doc-sweep, no behavior change) → 951 (post third batch, +10: A1 ×3, A2 ×4, A3 ×3) → 955 (post A4 fix, +4). Final: 955 passed, 0 failed.
