...
| `docs/research/EDGEMODEL_FOUNDATIONS.md` | **EdgeModel projection architecture audit (Plan 7, 2026-06-06).** 9 sections (7A–7I) validating EWMA spans, minute scalars, Vegas constraint, stat scalars/deflators, DK_STD, 3PM architecture, blend alphas against published literature. **Before changing any nba_projector.py constant, check this doc.** 7 NEEDS_CHANGE items (all July-refit backtest-gated, none urgent): STL/BLK span 8→~20, _AST_EWMA_SPAN table inverted, AST Vegas-anchoring, spot=1.6124 selection root-fix, FG% padding, HIGH_VAR relabel, evaluate_projector frame alignment. Key locks: blend alphas (don't refit — combination puzzle), PAD_3P=242 verified, OT cap, Vegas prior. |
