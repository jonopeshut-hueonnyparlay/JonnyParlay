...
3. **Phase 2 quick-wins** — progress:
   ...
   - **Remaining Phase 2:** P2.2 (no-vig daily-lay baseline, M), P2.3 (BM shrinkage target doc, M), P2.4 (travel/altitude — EdgeModel, L), P2.7 (Platt freshness — no JSON artifact; adapt to constant fit-date), P2.8 (portable paths — `JONNYPARLAY_HOME`), P2.9 (lineup_fetcher retry — EdgeModel), P2.11 (gate digest, M), P2.12 (schema migration framework, M). Then Phase 3.
