...
| 10 | `calibrate_platt.py` referenced by H3 plan + CLAUDE.md does not exist | missing file | Write it (logit-space fit on over_p_raw, slope prior per §3) before H3 fires | P1 — H3 gate is at 76/100 and approaching | §3; coordinator-verified by glob |
